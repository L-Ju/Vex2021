...
void opcontrol() {
	...
	Motor shooter(15);
	ControllerButton armUpBotton(ControllerDigital::A);
	ControllerButton armDownBotton(ControllerDigital::B);

	if(armUpBotton.isPressed()) {
		shooter.moveVoltage(12000);
	}
	else if(armDownBotton.isPressed()) {
		shooter.moveVoltage(-12000);
	}
	else{
